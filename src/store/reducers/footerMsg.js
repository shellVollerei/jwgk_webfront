...
export default (state = defaultState, action) => {
  ...
  switch (action.type) {
    case GET_FOOTER_MSG:
      ...
      console.log(Data);
      // const CompanyData = Data.companyData.data;
      // const ContactsData = Data.contactsData.data;
      ...
      // newState.block.children[0].childWrapper.children = SellLeaderDataList.slice(
      //   1
      // );
      // newState.block.children[1].childWrapper.children = MarketLeaderDataList.slice(
      //   1
      // );
      // newState.block.children[2].childWrapper.children = companyDataList.slice(
      //   1
      // );
